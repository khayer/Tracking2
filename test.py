...
first_upper_left_point1 = tuple([0,0])
first_upper_left_point2 = tuple([half_width,half_height])
first_upper_left_75_point1 = tuple([perc_75_width,perc_75_height])
first_upper_left_75_point2 = tuple([half_width-perc_75_width,half_height-perc_75_height])
first_upper_left_50_point1 = tuple([perc_50_width,perc_50_height])
first_upper_left_50_point2 = tuple([half_width-perc_50_width,half_height-perc_50_height])
first_upper_left_25_point1 = tuple([perc_25_width,perc_25_height])
first_upper_left_25_point2 = tuple([half_width-perc_25_width,half_height-perc_25_height])

first_upper_right_point1 = tuple([half_width,0])
